        ...
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          <div className="flex-1 space-y-8 text-center lg:text-right group animate-fade-in">
            ...
            <h1 className="text-5xl lg:text-7xl font-black text-slate-900 leading-[1.1] tracking-tight">
              <span className="block mb-2 text-primary">{settings.siteName}</span>
              <span className="block text-4xl mt-4">Akıllı Cihazlar</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-5 justify-center lg:justify-start pt-4">
              ...
              <Link to="/maintenance">
                <Button 
                  variant="outline" 
                  size="lg" 
                  className="h-14 px-10 text-lg font-bold border-2 border-slate-200 hover:border-secondary hover:bg-secondary/5 text-slate-700 hover:text-secondary rounded-2xl transition-all gap-2"
                >
            ...
            {/* إحصائيات سريعة */}
            <div className="flex items-center justify-center lg:justify-start gap-12 pt-10 border-t border-slate-100">
              <div className="text-center lg:text-right">
                <div className="text-3xl font-black text-slate-900 leading-none">2.5k+</div>
                <div className="text-xs font-bold text-slate-500 uppercase tracking-widest mt-2">Özel Ürün</div>
              </div>
              <div className="text-center lg:text-right">
                <div className="text-3xl font-black text-slate-900 leading-none">100%</div>
                <div className="text-xs font-bold text-slate-500 uppercase tracking-widest mt-2">Bakım Garantisi</div>
              </div>
            </div>
          </div>
